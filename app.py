...
class AutoDetectorApp(ctk.CTk):
    ...
    def initialize_image_tab_elements(self):
        self.image_path_header = ctk.CTkLabel(master=self.tab_view.tab("Image"), text="", font=("Arial", 20))
        self.image_path_header.place(relx=0.5, rely=0.6, anchor="center")

        self.image_error_path_header = ctk.CTkLabel(master=self.tab_view.tab("Image"), text="", font=("Arial", 20), text_color="red")
        self.image_error_path_header.place(relx=0.5, rely=0.6, anchor="center")

        self.image_path = ctk.CTkLabel(master=self.tab_view.tab("Image"), text="", font=("Arial", 15))
    ...
    def initialize_video_tab_elements(self):
        self.video_path_header = ctk.CTkLabel(master=self.tab_view.tab("Video"), text="", font=("Arial", 20))
        self.video_path_header.place(relx=0.5, rely=0.6, anchor="center")

        self.video_error_path_header = ctk.CTkLabel(master=self.tab_view.tab("Video"), text="", font=("Arial", 20), text_color="red")
        self.video_error_path_header.place(relx=0.5, rely=0.6, anchor="center")

        self.video_path = ctk.CTkLabel(master=self.tab_view.tab("Video"), text="", font=("Arial", 15))
